...
const ROLES = [
  ...
  },
  {
    ...
    dataScope: 'department' as DataScope, isSystem: true, allowedProfileTypes: [] as string[],
    permissionCodes: [
...
const DEPT_DATA = [
  { code: 'hq', name: '总公司', parentCode: null as string | null, sortOrder: 1 },
  ...
  { code: 'backend_dept', name: '后端组', parentCode: 'tech', sortOrder: 2 },
